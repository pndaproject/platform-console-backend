/*-------------------------------------------------------------------------------
* Name:        getApplications.spec.js
* Purpose:     Frisby file for testing the /applications API.
*
* Author:      PNDA Team
* Created:     2016/04/06
...
frisby.create('Get applications')
  .get('http://localhost:3123/api/dm/applications')
  .expectStatus(200)
  .expectHeaderContains('Content-Type', 'application/json')
  .expectJSONTypes('applications.*', {
    name: String,
    status: String,
    information: function(val) { expect(val).toBeTypeOrNull(Number); },
    package_name: String,
    overrides: Object,
    defaults: Object
  })
