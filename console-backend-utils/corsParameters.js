/*-------------------------------------------------------------------------------
 * Name:        corsParameters.js
 * Purpose:     Provides a function to check if a source address is in a list of approved sources.
 *
 * Author:      PNDA Team
 * Created:     2016/05/03
 * History:     2016/05/03 - Initial commit
 *
...
module.exports = {
  verifyOrigin: function(approvedList) {
